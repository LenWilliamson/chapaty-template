...
- **Dynamic Take Profit (TP)**: Set the TP using a Risk-Reward Ratio (`tp_crv`). TP distance = `SL distance * tp_crv` (default 2.0). 
  - *Example*: Breakout Range is $2,000. SL is placed $1,500 away. TP is placed $3,000 away.
